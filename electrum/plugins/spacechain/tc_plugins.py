...
from .tools import ErrorConnectingServer, TrustedCoinException, get_user_id, make_billing_address
...
DISCLAIMER = [
    _("Two-factor authentication is a service provided by Spacechain. "
...
class TCPlugin(BasePlugin):
    ...
    def request_billing_info(self, wallet: 'Wallet_tc', *, suppress_connection_error=True):
        ...
        wallet.add_new_billing_address(billing_index, billing_info['billing_address_segwit'], addr_type='segwit')
    ...
    def get_action(self, storage):
        ...
        if storage.get('wallet_type') != 'spacechain':
            return
    ...
    def get_xkeys(self, seed, t, passphrase, derivation):
        ...
        xtype = 'standard' if t == 'spacechain' else 'p2wsh'
